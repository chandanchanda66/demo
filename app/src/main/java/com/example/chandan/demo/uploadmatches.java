...
public class uploadmatches {
    private String t1,t2,t1score,t2score,t1overs,t2overs,t1wickets,t2wicets,result;
    ...
    public uploadmatches(String t1, String t2, String t1score, String t2score, String t1overs, String t2overs, String t1wickets, String t2wicets, String result) {
        this.t1 = t1;
        this.t2 = t2;
